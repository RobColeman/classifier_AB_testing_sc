...
class HypothesisTestingSpec extends WordSpec with Matchers with PrivateMethodTester {
  ...
  "HypothesisTests: Error and Accuracy" should {
    ...
    "accuracy should pass when it has diverged right" in {
    ...
    "accuracy should fail when it has diverged left" in {
    ...
    // Error
    "error should fail when it has not diverge left" in {
    ...
    "error should fail when it has diverged right" in {
    ...
    "error2way should pass when it has diverged left" in {
